...
app.controller('HistoryController', function ($scope, $rootScope, $timeout, auth) {
  ...
  var authData = auth.get();
  var intervalId = null;
  $scope.answer = " This is a styled Card. The header is created from a Thumbnail List item, This is a styled Card. The header is created from a Thumbnail List item, This is a styled Card. The header is created from a Thumbnail List item,";
